...
![alt text](resources/bounded-context-canvas-v5.jpeg "The Bounded Context Canvas V4")

Download the [blank canvas template](resources/bounded-context-canvas-5v-blank.jpeg).
